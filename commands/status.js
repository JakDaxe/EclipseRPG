...
exports.run = async (client, message, args) => {
  ...
  let forca = await db.get(`forca_${user.id}`);
    ...
    if (points === null) points = '0';
      ...
      .setDescription(`**Status** - **${user.username}**\n\n<:points:1072198464357810247> **Pontos**: \`${points}\`\n\n<:strength:1072212510175920168> **Força**: \`${forca} (${forca}kg)\`\n<:speed:1072197155269398618> **Velocidade**: \`${speed} (${speed}kmh)\`\n<:resistance:1072197485432426626> **Resistência**: \`${resist}\`\n<:breath:1072197862412267670> **Fôlego**: \`${folego} (${folego}00)\`\n<:blood:1072198040032641104> **Sangue**: \`${blood} (${blood}00)\` `)
      .setTimestamp()
      .setImage(imagy);
